package chapter12.multithread_01;
...
public class ProcessThread {
     ...
     *         - 이러한 분할을 시분할이라고 하는데 이와같은 분할 작업의 스위칭은 CPU의 연산이 매우 빠르게 이루어지기 때문에 덩달아 빠르게 움직이며 한정된 CPU 자원으로도 프로세스가 빠르게 동작한다
