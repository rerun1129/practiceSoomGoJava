package chapter13.generics_02._01_box._01_normal;
...
//        FruitBox <Fruit> fruitBox1 = new FruitBox <Apple> ( ); //다형성을 활용해서 자식 타입 변수 타입을 부모 타입 변수에 할당해도 컴파일 에러가 발생한다.
         ...
         * L5를 보면 CHECKCAST chapter13/generics_02/box/normal_01/Fruit 로 18행에서 Fruit 인스턴스를 꺼내서 사용할 때 비로소
         * 타입 캐스팅이 되고 그 이전에는 FruitBox<Obeject>로만 움직인다.
         * */
    }
}
